...
import { loginValidation, registerForm, submit } from "../../../utils/loginUtils";


export default class LoginForm extends Form {
    constructor(){
        super(Buttons.login,FormTitles.loginType,SwitchLinks.login,loginInputs,loginValidation)
