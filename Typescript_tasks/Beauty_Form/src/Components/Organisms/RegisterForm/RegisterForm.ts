...
import { loginForm, register, registerValidation } from "../../../utils/registerUtils";
...
export default class RegisterForm extends Form {
    ...
    constructor(){
        super(Buttons.register,FormTitles.registerType,SwitchLinks.register,registerInputs, registerValidation,genderInputs)
